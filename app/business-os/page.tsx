...
export default function BusinessOSPage() {
  return (
    <div className="bg-white text-light-body font-inter">
      {/* Hero */}
      <section className="max-w-5xl mx-auto px-6 md:px-16 py-20 flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 flex flex-col gap-7">
          <h1 className="text-light-heading font-bold text-4xl md:text-[46px] leading-tight tracking-tight">
        ...
        <div className="w-64 h-80 md:w-72 md:h-90 shrink-0 rounded-2xl overflow-hidden relative">
          <Image
